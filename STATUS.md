...
- **Social organization:** lifelong age/cohort groups cut across kin and organize labor, migration, ritual, and political obligations. Residence is flexible and may alternate seasonally between families; children can belong socially to several households.
- **Authority and prestige:** society is broadly egalitarian. Ritual specialists can gain influence through ecological, genealogical, and place-based knowledge. Prestige is deliberately plural: generosity, ecological competence, memory/eloquence, and ritual skill can all matter, limiting permanent elite formation.
...
- **Landscape and personhood:** certain animals, waters, storms, and other nonhuman beings can be social actors. Landscape is ancestral and agentive; responsiveness and reciprocity are culturally salient distinctions alongside ordinary human/nonhuman categories.
...
- **Guests and outsiders:** strangers may be treated cautiously, but properly received guests acquire strong protection and reciprocal obligations.
- **Death and ancestry:** the dead remain associated with routes, camps, and landscape features and may gradually merge into a collective ancestral presence.
